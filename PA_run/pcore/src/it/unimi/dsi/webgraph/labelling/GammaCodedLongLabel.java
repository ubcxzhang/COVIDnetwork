...
/*
 * Adapted from GammaCodedIntLabel by Alex Thomo, Jan 2018.
 */
...
/** A natural number represented in {@linkplain OutputBitStream#writeGamma(long) &gamma; coding}. */
...
public class GammaCodedLongLabel extends AbstractLongLabel {
	 ...
	 */
	public GammaCodedLongLabel( String key, long value ) {
		super( key, value );
	 ...
	 */
	public GammaCodedLongLabel( String... key  ) {
		super( key[ 0 ], 0 );
	}
